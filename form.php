        ...
        <div id="wrapper">
            <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
                ...
                <div style="color: white;
                     ...
                     $accesstime = fileatime('./form.php');
                     
                     $date = getdate($accesstime);
                     echo $date['weekday']." ".$date['month']." ".$date['mday']." ".$date['year'];
                     echo "at ".$date['hours'].":".$date['minutes'].":".$date['seconds'];
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <form action="aggregateParty.php" method="post">
                                                <button type="submit" name="tally" class="btn btn-primary">Tally Total </button>
                                            </form>
                                            <div class="panel panel-info">
                                                <div class="panel-body">
                                                    <div class="table-responsive">
                                                        <table class="table table-striped table-bordered table-hover" id="dataTables-totalResult">
                                                            <thead>
                                                                <tr>
                                                                    <th>Party Name</th>
                                                                    <th>Number of parliament Sit</th>
                                                                </tr>
                                                            </thead>
                                                            <tbody>
                                                                <?php
                                                                ...
                                                                $query = "select distinct party_name,result from total_result";
                                                                $result = mysqli_query($connection, $query) or die("Invalid Query: " . mysqli_error($connection));
                                                                while ($row = mysqli_fetch_row($result)) {
            ...
            <script>
                $(document).ready(function () {
                    ...
                    $('#dataTables-totalResult').dataTable();
                }
            </script>
